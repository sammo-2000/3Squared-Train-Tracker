...
const icons = {
  // This is where you add to the navbar
  2: icon2,
  3: icon3,
  4: icon4,
  5: icon5,
    ...
    <div className="shadow-box">
      ...
      >
        ...
        {Object.entries(icons).map(
          (
            [id, iconSrc] // Goes through each of the icons objects and renders them in the navbar with there set icon
          ) => (
            <div
              key={id}
              className="hover:bg-[#D8D8D8] rounded-lg max-h-12 flex justify-center w-[90%] mx-[5%] m-4"
              onClick={() => handleIconClick(Number(id))}
            >
